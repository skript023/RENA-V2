...
const tickets = ref<Ticket[]>([
    ...
    },
    {
      ...
      description: 'Feature money drop di RDR mod menu tidak memberikan uang ketika digunakan di Red Dead Online...',
    ...
    },
    {
      ...
      description: 'Ketika menggunakan teleport feature di mod menu, game langsung crash ke desktop tanpa error message...',
    ...
    },
    {
      ...
      description: 'Feature weapon spawner di mod menu bisa spawn senjata biasa tapi tidak bisa spawn legendary weapons...',
    ...
    },
    {
      ...
      description: 'God mode feature aktif melindungi dari gunshot dan animal attacks, tapi karakter masih mati kalau jatuh dari ketinggian...',
