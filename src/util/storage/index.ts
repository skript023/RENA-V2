...
{
    private key = CryptoJS.enc.Utf8.parse('1234567890123456'); // 16 bytes key for AES-128
    private iv = CryptoJS.enc.Utf8.parse('1234567890123456'); // Initialization vector
    ...
    setRawData(key: string, value: string) 
    {
